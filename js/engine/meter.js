...
export function createErrorMeter(max = 100, missPenalty = 20, hitRecovery = 2, decayRate = 1.5) {
    return { value: 0, max, missPenalty, hitRecovery, decayRate };
}
/** Register a miss — increases error */
export function registerMiss(meter) {
 ...
 */
export function renderErrorMeter(ctx, meter, x, y, radius) {
    ...
    const color = progress < 0.3 ? 'rgba(78, 205, 196, 0.8)' // teal
