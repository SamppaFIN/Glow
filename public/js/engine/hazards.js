...
export function getHazardsForLevel(level) {
    switch (level) {
...
export function spawnHazard(type, x, y, targetShape) {
    const configs = {
...
// ── Update hazards ────────────────────────────────────────────
export function updateHazards(hazards, affected, shapes, delta, canvasW, canvasH) {
...
// ── Render hazards ────────────────────────────────────────────
export function renderHazards(ctx, hazards, gameTime) {
